...
public abstract class Statement {
	 ...
	 public void checkTimeLeft(Ship ship,World world, Program program, double deltaT) throws NoMoreTimeException {
		 ...
		 if (program.getEndingSourceLocation() != null){
			 if ((this.getSourceLocation().getLine() == (program.getEndingSourceLocation().getLine())) 
					 && (this.getSourceLocation().getColumn() == program.getEndingSourceLocation().getColumn())) {	 
		 ...
		 if ((deltaT-program.getConsumedTime())<0.2) {
			 if ((program.getEndingSourceLocation() == null) 
					 || (program.getEndingSourceLocation().getLine() <= this.getSourceLocation().getLine()) 
					 && (program.getEndingSourceLocation().getColumn() <= this.getSourceLocation().getColumn())) {
